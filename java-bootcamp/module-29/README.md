...
**Critical:** Annotate DTOs + **`@Valid`**. Global **`@RestControllerAdvice`** returns stable **`ErrorResponse`**. Map
**400 / 404 / 409**. Keep **`lab-request-001`** on errors. Assert status **and** body. No stack-trace HTML. Keep Lab 28
JWT/security. Unifies Lab 14/16 into Boot.
