...
**Critical:** **Authn ≠ authz**. Stateless **SecurityFilterChain** + **JWT**. Roles **AGENT** / **ADMIN**. Prove **401**
vs **403**. Login `permitAll`; protect customers/admin differently. **Never commit JWT secrets**. Correlation
`lab-request-001` is not authentication. Lab 29 adds validation polish.
