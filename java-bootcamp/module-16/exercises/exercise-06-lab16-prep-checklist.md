...
From `examples/module-16-exercises/`, create `notes/` if needed, then create `notes/lab16-prep-checklist.md`.
...
| notes/lab16-errorresponse-json.md | _____ |
| notes/lab16-status-map.md | _____ |
