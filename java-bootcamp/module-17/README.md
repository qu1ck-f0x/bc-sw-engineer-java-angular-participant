...
| F    | Graded lab (Checkpoint E)                                                                       | [`lab17/LAB-17-GUIDE.md`](lab17/LAB-17-GUIDE.md) — completed path [`lab17/completed/`](lab17/completed/README.md) (~45 min)                                                              |
| G    | Done                                                                                            | Mark Pass/Fail · Kahoot if scheduled                                                                                                                                                     |

**Classroom practice order:** **1 → 2 → 3 → 4 → 5 → 6**

**Pre-lab vs lab:** Notes stay under `module-17/exercises/notes/`. Finished lab work stays under
`module-17/lab17/completed/`.

**Critical:** Meaningful asserts (id/status/`BusinessException`). JaCoCo gate on `com.northstar.crm.service` ≥ **0.80**
via `mvn clean verify`. Mockito deep dive is **Lab 18**. Review AI-generated tests — do not ship `assertTrue(true)`.
