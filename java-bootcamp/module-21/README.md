...
**Critical:** **Low-cardinality** metric tags only. **Liveness ≠ readiness**. Actuator **allow-list** — lab exposure is
not production. Correlate alerts with **logs** (`lab-request-001`), not customerId labels.
