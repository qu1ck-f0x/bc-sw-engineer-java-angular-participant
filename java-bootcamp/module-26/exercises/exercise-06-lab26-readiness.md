...
From `examples/module-26-exercises/`, create `notes/` if needed, then create `notes/lab26-readiness.md`.
...
| notes/lab26-profile-yaml-todos.md | _____ |
| notes/northstar-props.md | _____ |
...
Confirm fixtures if used: Amina `CUS-1001`/`ACTIVE`, Ravi `CUS-1002`/`PROSPECT`, correlation `lab26-001` /
`lab-request-001`. Replace every `_____` before Pass. **Never write real passwords.**
