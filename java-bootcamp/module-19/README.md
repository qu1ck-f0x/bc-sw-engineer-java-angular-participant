...
**Graded project:** `examples/lab19-crm/` — Spring Boot `@SpringBootTest` / MockMvc, PostgreSQL test strategy, Selenium
against **Angular**, GitHub Actions headless notes.

**Critical:** UI automation targets **Angular** (`data-testid`, explicit waits). Test database strategy is
**PostgreSQL** (Testcontainers or dedicated test DB) — not Oracle. CI path is **GitHub Actions**, not Bitbucket.
Fixtures: `CUS-1001` Amina Khan ACTIVE, `CUS-1002` Ravi Singh PROSPECT, correlation `lab-request-001`.
