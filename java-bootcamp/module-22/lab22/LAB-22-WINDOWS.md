...
**Other
OS:** [macOS guide](LAB-22-MACOS.md) · [IDE conventions](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/_IDE-CONVENTIONS.md)
...
Complete every step in **[LAB-22-GUIDE.md](LAB-22-GUIDE.md)**. Wherever the GUIDE shows `~/java-bootcamp`, use
...
Save under `%USERPROFILE%\java-bootcamp\notes\screenshots\lab-22`. Capture IntelliJ (project tree + Run/Terminal).
Redact secrets.
