...
Returning a bare array makes paging impossible for the client, and an unversioned API cannot evolve without breaking
consumers.
...
Query parameters with defaults, a paging envelope, a justified version strategy, and a breaking-change rule in
`notes/lab13-collection-versioning.md`.
