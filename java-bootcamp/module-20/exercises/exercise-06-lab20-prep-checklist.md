...
From `examples/module-20-exercises/`, create `notes/` if needed, then create `notes/lab20-prep-checklist.md`.
...
| notes/lab20-safe-logs.md | _____ |
| notes/lab20-mdc-lifecycle.md | _____ |
