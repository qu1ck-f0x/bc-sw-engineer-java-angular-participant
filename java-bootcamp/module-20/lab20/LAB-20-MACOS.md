...
**Other
OS:** [Windows guide](LAB-20-WINDOWS.md) · [IDE conventions](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/_IDE-CONVENTIONS.md)
...
| Evidence / screenshots  | `~/java-bootcamp/notes/screenshots/lab-20` |
...
mkdir -p notes/screenshots/lab-20
...
Save under `~/java-bootcamp/notes/screenshots/lab-20`. Capture IntelliJ (project tree + Run/Terminal). Redact secrets.
